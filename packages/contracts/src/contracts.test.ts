...
import { ActivityItemSchema, ActivitySpecSchema, CurriculumDefinitionSchema, CurriculumPackRevisionSchema, EvaluationSchema, LearnerRoadmapSchema, ProgressEventSchema, StudentSchema, toChildActivitySpec, toChildLearnerRoadmap } from "./index.js";
...
describe("versioned learning contracts", () => {
  ...
  it("accepts open subjects and removes roadmap analytics from child output", () => {
    ...
    expect(child.edges).toHaveLength(0);
  });
