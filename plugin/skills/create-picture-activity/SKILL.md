...
- Create and validate the complete activity specification before rendering. Deterministically verify counts, labels, item-to-asset references, answer keys, and scoring in application code.
