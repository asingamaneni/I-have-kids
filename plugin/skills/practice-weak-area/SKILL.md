---
name: practice-weak-area
description: "Select targeted reinforcement for a recurring, evidence-backed weak sub-skill."
whenToUse: When repeated mistake patterns call for focused practice.
argumentHint: "[student-id] [concept-or-area] [session-minutes]"
model: inherit
effort: medium
---
...
4. Store recommendation/activity lineage and explain why the weak area was selected. Do not change progress until a later validated evaluation is processed.
